    ...
    private void initComponent(){
     setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      ...
      Container contenedor = getContentPane();
        ...
        caja1 = new JTextField("numero a operar");
        caja1.setBounds(300, 150, 150, 30);
        contenedor.add(caja1);
        caja2 = new JTextField("numero a operar 2");
        caja2.setBounds(300, 200, 150, 30);
        contenedor.add(caja2);
        caja3 = new JTextField("total");
        caja3.setBounds(300, 300, 150, 30);
        contenedor.add(caja3);
        caja4 = new JTextField("Introduce el numero a convertir");
        caja4.setBounds(300, 50, 150, 30);
